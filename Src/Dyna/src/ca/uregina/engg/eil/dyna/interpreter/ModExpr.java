/* Generated By:JJTree: Do not edit this line. ModExpr.java */

/**
 * AST Node for mod (%) expression
 *
...
public class ModExpr extends SimpleNode {
  public ModExpr(int id) {
    super(id);
  }

  public ModExpr(TBLParser p, int id) {
    super(p, id);
  }
