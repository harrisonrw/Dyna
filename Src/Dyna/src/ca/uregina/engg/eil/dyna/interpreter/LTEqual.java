/* Generated By:JJTree: Do not edit this line. LTEqual.java */

/**
 * AST Node for less-than-equal (<=) expression
 *
...
public class LTEqual extends SimpleNode {
  public LTEqual(int id) {
    super(id);
  }

  public LTEqual(TBLParser p, int id) {
    super(p, id);
  }
