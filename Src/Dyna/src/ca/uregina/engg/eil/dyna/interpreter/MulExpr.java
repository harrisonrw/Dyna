/* Generated By:JJTree: Do not edit this line. MulExpr.java */

/**
 * AST Node for multiplication (*) expression
 *
...
public class MulExpr extends SimpleNode {
  public MulExpr(int id) {
    super(id);
  }

  public MulExpr(TBLParser p, int id) {
    super(p, id);
  }
